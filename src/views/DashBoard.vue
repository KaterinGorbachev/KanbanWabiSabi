  ...
  >
    ...
    <main class="flex flex-col justify-between gap-6">
      <div class="flex flex-col justify-between gap-1">
        <h1
          class="text-3xl text-amber-950 text-shadow-emerald-950 font-[Zen_Maru_Gothic] font-bold"
        >
          Wabi Sabi Board
        </h1>
        <h2 class="text-white text-shadow-emerald-950 text-xl font-bold">
          ¡Bienvinido de nuevo, {{ usuario?.email }}!
        </h2>
        <p class="text-white text-shadow-emerald-950">
